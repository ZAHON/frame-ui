...
describe('warn', () => {
  ...
  it('should log a simple warning message with the correct prefix', () => {
    ...
    expect(mockConsoleWarn).toHaveBeenCalledWith('Frame UI: A simple test message.');
  });
  ...
  it('should join multiple string arguments into a single message', () => {
    ...
    expect(mockConsoleWarn).toHaveBeenCalledWith('Frame UI: This is a multi-part message');
  });
});
