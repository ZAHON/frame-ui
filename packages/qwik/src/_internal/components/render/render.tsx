import type { Tag, RenderProps } from './render.types';
 ...
 */
export const Render = <T extends Tag, S extends Record<string, unknown> = {}>(props: RenderProps<T, S>) => {
  ...
  if (render$) {
    ...
    return defaultRender$(finalOthers as Record<string, unknown>);
  }
};
