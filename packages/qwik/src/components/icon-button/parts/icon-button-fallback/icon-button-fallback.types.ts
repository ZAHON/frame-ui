...
export interface IconButtonFallbackProps extends PropsOf<'span'> {
  /**
   * When `true`, the component will be rendered even if the icon button is not in the loading state.
   * @default false
   */
  forceMount?: boolean;
