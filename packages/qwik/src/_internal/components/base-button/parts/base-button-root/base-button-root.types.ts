...
export interface BaseButtonRootProps extends PropsOf<'button'> {
  /**
   * The shape of the base button.
   */
  shape: 'rectangle' | 'square';

  /**
   * The size of the base button.
   * @default "2"
   */
  size?: '1' | '2' | '3' | '4';

  /**
   * The visual style of the base button.
   * @default "solid"
   */
  variant?: 'solid' | 'soft' | 'surface' | 'outline' | 'ghost';

  /**
   * The color of the base button.
   * @default "primary"
   */
  color?: 'default' | 'primary' | 'success' | 'warning' | 'danger';

  /**
   * If `true`, the base button will use a higher contrast color palette.
   * @default false
   */
  ...
  /**
   * When `true`, prevents the user from interacting with the base button.
   * @default false
   */
  disabled?: boolean;

  /**
   * If `true`, the base button is put into a pending state.
